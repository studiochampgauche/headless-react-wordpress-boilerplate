	...
	public function acf(){
		...
		acf_add_local_field_group( array(
			...
			array(
				...
				'label' => __('Version', 'cg-core'),
				'name' => 'cache_version',
				'aria-label' => '',
				'type' => 'number',
				'instructions' => __('Laissez à zéro pour désactiver.', 'cg-core'),
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '20',
			...
			array(
				...
				'label' => __('Expiration', 'cg-core'),
				'name' => 'cache_expiration',
				'aria-label' => '',
				'type' => 'number',
				'instructions' => __('Inscrivez un nombre en seconde.', 'cg-core'),
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '20',
			...
			array(
				...
				'label' => __('Consentement', 'cg-core'),
				'name' => 'consent_module',
				'aria-label' => '',
				'type' => 'true_false',
				'instructions' => __('Voulez-vous afficher une boite de consentement?', 'cg-core'),
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
			...
			array(
				...
				'label' => __('Boite de consentement', 'cg-core'),
				'name' => '',
				'aria-label' => '',
				'type' => 'tab',
				'instructions' => '',
			...
			array(
				...
				'label' => __('Configurations', 'cg-core'),
			...
			array(
				...
				'sub_fields' => array(
					array(
						...
						'label' => __('Texte de l\'onglet', 'cg-core'),
						'name' => 'tab_name',
						'aria-label' => '',
						'type' => 'text',
						'instructions' => '',
					...
					array(
						...
						'label' => __('Titre de l\'en-tête', 'cg-core'),
						'name' => 'header_title',
						'aria-label' => '',
						'type' => 'group',
						'instructions' => '',
					...
					array(
						...
						'label' => __('Texte principal', 'cg-core'),
						'name' => 'main_text',
						'aria-label' => '',
						'type' => 'wysiwyg',
						'instructions' => '',
					...
					array(
						...
						'label' => __('Bouton d\'acceptation', 'cg-core'),
						'name' => 'accept_button',
						'aria-label' => '',
						'type' => 'group',
						'instructions' => '',
					...
					array(
						...
						'label' => __('Bouton de refus', 'cg-core'),
						'name' => 'reject_button',
						'aria-label' => '',
						'type' => 'group',
						'instructions' => '',
					...
					array(
						...
						'max' => 0,
						'collapsed' => '',
						'button_label' => __('Ajouter un lien', 'cg-core'),
						'rows_per_page' => 20,
						'sub_fields' => array(
							array(
							...
							array(
								...
								'label' => __('Nouvel onglet', 'cg-core'),
								'name' => 'new_tab',
								'aria-label' => '',
								'type' => 'true_false',
								'instructions' => '',
							...
							array(
								...
								'label' => __('Page Transition', 'cg-core'),
